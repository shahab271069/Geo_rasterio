...
# Joe McGlinchy, Earth Lab, University of Colorado at Boulder
...
for year in {2002..2003}
        ...
        do 
        curl --limit-rate 3M -o daymet_v3_prcp_monttl_${year}_${loc}.nc4 https://thredds.daac.ornl.gov/thredds/fileServer/ornldaac/1345/daymet_v3_prcp_monttl_${year}_${loc}.nc4
        curl --limit-rate 3M -o daymet_v3_tmin_monavg_${year}_${loc}.nc4 https://thredds.daac.ornl.gov/thredds/fileServer/ornldaac/1345/daymet_v3_tmin_monavg_${year}_${loc}.nc4
        curl --limit-rate 3M -o daymet_v3_tmax_monavg_${year}_${loc}.nc4 https://thredds.daac.ornl.gov/thredds/fileServer/ornldaac/1345/daymet_v3_tmax_monavg_${year}_${loc}.nc4
        curl --limit-rate 3M -o daymet_v3_vp_monavg_${year}_${loc}.nc4 https://thredds.daac.ornl.gov/thredds/fileServer/ornldaac/1345/daymet_v3_vp_monavg_${year}_${loc}.nc4
        done
